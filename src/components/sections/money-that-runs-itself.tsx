...
import { TreasuryConsoleWidget } from "@/components/widgets/treasury-console/treasury-console-widget";
import { sectionReveal } from "@/lib/animation";

export function MoneyThatRunsItself() {
  return (
    <div className="mx-auto max-w-7xl px-8 mt-16 md:mt-24">
      <motion.section
        aria-label="Money That Runs Itself"
